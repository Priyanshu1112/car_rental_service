<div class="shadow-md fixed w-full z-10 bg-white">
    <div
      class=" container flex items-center justify-between px-4 py-4 sm:px-6 lg:px-8"
    >
      <div class="inline-flex items-center space-x-2">
        <span class="font-bold text-[#3563E9]">MORENT</span>
      </div>
